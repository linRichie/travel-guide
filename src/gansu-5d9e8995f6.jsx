            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="bg-gradient-to-br from-orange-500/10 to-orange-700/10 border border-orange-500/20 p-6 rounded-xl">
                  ...
                  <div className="text-gray-400">热门景点</div>
                </div>
                <div className="bg-gradient-to-br from-orange-500/10 to-orange-700/10 border border-orange-500/20 p-6 rounded-xl">
                  <div className="text-4xl font-bold text-orange-500">5</div>
                  <div className="text-gray-400">世界遗产</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {attractions.map((attraction, index) => (
                <motion.div
                  key={index}
                  whileHover={{ y: -10 }}
                  className="bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-800 rounded-xl overflow-hidden group"
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-400 text-sm mb-4">{attraction.address}</p>
              ...
              <div className="p-6">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-gray-400">点击地图标记查看景点详情</p>
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-400">探索丝绸之路的千年传奇</p>
            </div>
